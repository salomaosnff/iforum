...
declare module 'swagger:iforum' {
  ...
  export namespace Services {
    ...
    export class Topics {
      constructor(handler: <T>(request: ApiRequest) => Promise<ApiResponse<T>>);
      /**
       * @endpoint POST http://localhost:3000/topics
       * @contentType application/json
       *
      ...
      /**
       * @endpoint GET http://localhost:3000/topics/{slug}
       *
      ...
      /**
       * @endpoint PATCH http://localhost:3000/topics/{slug}
       * @contentType application/json
       *
      ...
      /**
       * @endpoint DELETE http://localhost:3000/topics/{slug}
       *
      ...
      /**
       * @endpoint POST http://localhost:3000/topics/{slug}/rate
       * @contentType application/json
       *
    ...
    export class Comments {
      constructor(handler: <T>(request: ApiRequest) => Promise<ApiResponse<T>>);
      /**
       * @endpoint GET http://localhost:3000/topics/{slug}/comments
       *
      ...
      /**
       * @endpoint POST http://localhost:3000/topics/{slug}/comments
       * @contentType application/json
       *
      ...
      /**
       * @endpoint PATCH http://localhost:3000/topics/{slug}/comments/{id}
       * @contentType application/json
       *
      ...
      /**
       * @endpoint DELETE http://localhost:3000/topics/{slug}/comments/{id}
       *
      ...
      /**
       * @endpoint POST http://localhost:3000/topics/{slug}/comments/{id}/rate
       * @contentType application/json
       *
    ...
    export class Tags {
      constructor(handler: <T>(request: ApiRequest) => Promise<ApiResponse<T>>);
      /**
       * @endpoint GET http://localhost:3000/tags/following
       *
      ...
      /**
       * @endpoint POST http://localhost:3000/tags/following
       * @contentType application/json
       *
      ...
      /**
       * @endpoint DELETE http://localhost:3000/tags/following
       *
